        ...
        <div className="w-full rounded-2xl border border-[#e5e5e5] bg-white p-4 sm:p-6 lg:p-8 shadow-[0_12px_30px_rgba(0,0,0,0.08)]">
          ...
          <div className="mt-6 sm:mt-8 space-y-4 sm:space-y-5 lg:space-y-6">
            <section className="rounded-2xl border border-[#e5e5e5] bg-white p-4 sm:p-5 lg:p-6">
              <h2 className="text-xs font-bold uppercase  text-[#555555]">Order Details</h2>
            ...
            <section className="rounded-2xl border border-[#e5e5e5] bg-white p-4 sm:p-5 lg:p-6">
              <h2 className="text-xs font-bold uppercase text-[#555555]">Shipping Address</h2>
            ...
            <section className="rounded-2xl border border-[#e5e5e5] bg-white p-4 sm:p-5 lg:p-6">
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="flex-1 rounded-full border border-[#cc071e] py-2.5 text-center text-xs font-bold uppercase text-[#cc071e] transition-all hover:bg-[#cc071e] hover:text-white"
                >
                  Track Order
                </Link>
                <Link
                  href="/"
                  className="flex-1 rounded-full bg-[#111111] py-2.5 text-center text-xs font-bold uppercase text-white transition-all hover:bg-[#333]"
                >
                  Continue Shopping
                </Link>
              </div>
