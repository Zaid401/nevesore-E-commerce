    ...
    <main className="min-h-screen bg-[#f8f8f8] text-[#111111]">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 sm:py-10 lg:py-12">
        <div className="mb-6 sm:mb-8 text-center">
          <h1 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-[0.2em]">Track Your Order</h1>
          <p className="mt-2 text-xs sm:text-sm text-[#555555]">
            Enter your order number to view order status.
          </p>
        </div>
          ...
          <div className="mt-6 sm:mt-8 space-y-4 sm:space-y-5 lg:space-y-6 animate-[fadeIn_0.4s_ease-out]">
            ...
            <section className="rounded-2xl border border-[#e5e5e5] bg-white p-4 sm:p-5 lg:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)]">
              <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#555555]">Payment</p>
                  <span
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#555555]">Total</p>
